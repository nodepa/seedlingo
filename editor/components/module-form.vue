<template>
  <UModal title='Add new module' description="Describe the module"
    ...
    <UButton class="self-center" :color="isAddMode ? 'primary' : 'neutral'">
      <UIcon
        :name="isAddMode ? 'material-symbols-add' : 'material-symbols-edit-note'" />
    ...
    <template #body>
      <UForm :schema="ModuleSchema" :state="state" @submit="emitUpdateModule">
        ...
        <div class="flex justify-end space-x-2">
          ...
          <UButton color="neutral" @click="showModuleForm = false">
            Cancel
          </UButton>
        </div>
      </UForm>
